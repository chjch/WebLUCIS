// import { geojsonData,formColumns} from './header_tab.js';
// import { GeoJsonLayer, deckgl } from './AJAX_multiple.js';
...
// }
// export function updatemap(response, formUrl) {
...
import { geojsonData } from './header_tab.js';
import { GeoJsonLayer, deckgl } from './AJAX_multiple.js';
var selectedWord;
var selectedcolors;
var initialColors = [
...
export function updatemap(response) {
    ...
    bufferButton.click();
    $(`.tablinks[data-tab="Buffer"]`).addClass('active');
    Object.assign(geojsonData, response);
    generateColorPalettes();
    let intervalmethod = $("#intervalMethod").val();
    let intervals;
    if (intervalmethod === 'quantify') {
